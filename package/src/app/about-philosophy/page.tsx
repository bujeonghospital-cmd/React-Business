...
export default function AboutPhilosophy() {
  ...
  const missions: { textS: string; textE: string }[] = [
    {
      textS: "ดำเนินธุรกิจให้เติบโตอย่างยั่งยืน",
      textE: "สร้างผลกำไรและผลตอบแทนที่ดี ด้วยหลักธรรมาภิบาล",
    },
    {
      textS: "ผลิตสินค้าให้มีคุณภาพได้มาตรฐาน ส่งมอบสินค้าถูกต้องตรงเวลา",
      textE:
        "พัฒนาระบบบริหารคุณภาพและบริการอย่างต่อเนื่อง เพื่อความพึงพอใจและไว้วางใจของลูกค้า",
    },
    {
      textS:
        "เพิ่มประสิทธิภาพในการผลิตและการดำเนินงานลดความสูญเสียและความซ้ำซ้อน",
      textE: "ปรับปรุงพัฒนาให้มีความรวดเร็วและมีคุณภาพที่ดีขึ้นอย่างต่อเนื่อง",
    },
    {
      textS: "บริหารจัดการวัตถุดิบเลือกใช้วัตถุดิบที่มีคุณภาพ ",
      textE:
        "ปลอดภัยเพื่อเพิ่มประสิทธิภาพในการผลิตและการแข่งขันทั้งในด้านราคาและคุณภาพ",
    },
    {
      textS: "สร้างสรรค์นวัตกรรม",
      textE:
        "ความแตกต่างของผลิตภัณฑ์โดยนำเสนอ ให้คำแนะนำและแก้ไขปัญหาให้แก่ลูกค้า",
    },
    {
      textS: "ส่งเสริมและพัฒนาบุคลากรให้มีศักยภาพ",
      textE:
        "มีความคิดสร้างสรรค์มีทักษะที่ดีขึ้นอย่างต่อเนื่อง สร้างจิตสำนึก ความมีระเบียบวินัยทัศนคติที่ดี พร้อมให้คุณภาพชีวิตของพนักงานดีขึ้น",
    },
    {
      textS:
        "ส่งเสริมและดำเนินการให้องค์กรเป็นสถานที่ทำงานที่มีความสุขความปลอดภัย",
      textE: "และมีการสื่อสารและการทำงานร่วมกันเป็นทีมอย่างมีประสิทธิภาพ",
    },
    {
      textS:
        "สร้างพันธมิตรคู่ค้าทางธุรกิจบนพื้นฐาน ความร่วมมือที่ดีเติบโตร่วมกันอย่างยั่งยืน",
      textE: "พร้อมมีส่วนร่วมในการสนับสนุนดูแลสังคม และสิ่งแวดล้อม",
    },
